...
public class TestInstitution extends AndroidTestCase{
	...
	public void testShouldGetInstitutionsByEvaluationFilter() {
		...
		institutions = Institution.getInstitutionsByEvaluationFilter("triennial_evaluation", "2010", "2", "5");
		assertEquals(1, institutions.size());
	...
	public void testShouldGetCoursesByEvaluationFilter() {
		...
		courses = Institution.getCoursesByEvaluationFilter(Integer.toString(eva[0].getIdInstitution()), "triennial_evaluation", "2007", "7", "9");
		assertEquals(1, courses.size());
		assertEquals("name course 1", courses.get(0).getName());
		
		courses = Institution.getCoursesByEvaluationFilter(Integer.toString(eva[1].getIdInstitution()), "triennial_evaluation", "2010", "2", "5");
		assertEquals(1, courses.size());
